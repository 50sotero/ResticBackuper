      ...
      {chunks.map((chunk, i) => (
        ...
        >
          <div className="primitive-card-bar flex items-center gap-2.5 border-b border-line">
            ...
            {chunk.action && <span className="ml-auto shrink-0">{chunk.action}</span>}
            <span className="shrink-0 text-[12px] text-ink-3 tabular-nums">{chunk.chars}</span>
          </div>
